    ...
    <div class="container">
        <div class="row text-center">
            <div class="col collapse" id="collapseExample">
                <img src="https://jcrodsolutions.com/resources/img/logo.png" alt="JCRodSolutions">
            </div>
        </div>
        ...
        <div class="row text-center py-3">
            <div class="col col-offset-2 text-center ">
                <button class="btn btn-primary btn-lg text-warning" data-bs-toggle="collapse" data-bs-target="#collapseExample">
                    <i class="fa-solid fa-arrow-right fa-pull-left fa-border"></i>GO!
                </button>
            </div>
        </div>
    </div>
